...
namespace {
  ...
  TEST(UUIDTest, ParsePretty) {
    ...
    UUID::UUID uuid = UUID::UUID::fromStrFactory("00010203-0405-0607-0809-0a0b0c0d0e0f");
  ...
  TEST(UUIDTest, Comparisons) {
    UUID::UUID uuid = UUID::UUID::fromStrFactory("00120034-0056-0078-0012-003400560078");
    UUID::UUID uuid2 = UUID::UUID(uuid);

    ASSERT_TRUE(uuid == uuid2);
    ASSERT_FALSE(uuid < uuid2);

    UUID::UUID uuid3 = UUID::UUID::fromStrFactory("f0120034-0056-0078-0012-003400560078");
    ASSERT_TRUE(uuid < uuid3);

    UUID::UUID uuid4 = UUID::UUID::fromStrFactory("00020034-0056-0078-0012-003400560078");
    ASSERT_FALSE(uuid < uuid4);
    ASSERT_TRUE(uuid > uuid4);

    UUID::UUID uuid5 = UUID::UUID::fromStrFactory("fc120034-0056-0078-0012-003400560078");
